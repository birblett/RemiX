...
# SCEPTILE-MEGA
PokeModifier.add(:SCEPTILE, "Mega Form")
...
PokeModifier.add(:ZIGZAGOON)
            .abilities({ 1 => :TOXICBOOST })
            .set_pokebilities

# ZIGZAGOON-GALAR
PokeModifier.add(:ZIGZAGOON, "Galarian Form")
            .abilities({ 1 => :TOXICBOOST }) if Rejuv
...
# LINOONE-GALAR
PokeModifier.add(:LINOONE, "Galarian Form")
            .abilities({ 1 => :TOXICBOOST }) if Rejuv

# BEAUTIFLY
PokeModifier.add(:BEAUTIFLY)
            .abilities({ 1 => :GALEFORCE })
...
# AGGRON-MEGA
PokeModifier.add(:AGGRON, "Mega Form")
            .type2(:DRAGON)
...
# ROSELIA-AEVIUM
PokeModifier.add(:ROSELIA, "Aevian Form")
            .set_pokebilities(1)
...
PokeModifier.add(:TORKOAL)
            .level_moves([[45, :SCALD]])

# SPOINK
PokeModifier.add(:SPOINK)
            .type2(:GROUND)
            .abilities({ 1 => :SWINEFORCE })
...
PokeModifier.add(:LUNATONE, "Lunatone Dominant Fusion")
            .type1(:GHOST)
            .set_plates([:ICICLEPLATE])
            .level_moves([[40, :SHADOWBALL], [70, :MOONGEISTBEAM]]) if Rejuv
...
PokeModifier.add(:SOLROCK, "Solrock Dominant Fusion")
            .type1(:STEEL)
            .set_plates([:FLAMEPLATE])
            .level_moves([[40, :IRONHEAD], [70, :SUNSTEELSTRIKE]]) if Rejuv

# CRAWDAUNT
PokeModifier.add(:CRAWDAUNT)
            .level_moves([[50, :CLOSECOMBAT]])
...
# MILOTIC-AEVIUM
PokeModifier.add(:MILOTIC, "Aevian Form")
...
# BANETTE-MEGA
PokeModifier.add(:BANETTE, "Mega Form")
            .type2(:DARK)
...
# ABSOL-MEGA
PokeModifier.add(:ABSOL, "Mega Form")
            .type2(:FAIRY)
...
# RAYQUAZA-MEGA
PokeModifier.add(:RAYQUAZA, "Mega Form")
            .set_plates([:SPLASHPLATE, :FLAMEPLATE])
