CrestBuilder.add(:RATICATE, "Gain innate Parental Bond.")
            .ability_provider { |_, _| next :PARENTALBOND }

CrestBuilder.add(:CLEFABLE, "When damage is taken, gain Laser Focus and increase accuracy. Take less damage while at max health.")
...
CrestBuilder.add(:HITMONCHAN, "First use of a punching move deals double damage.")
...
CrestBuilder.add(:LAPRAS, "Gain resistances to Fighting and Rock.")
