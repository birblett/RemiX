CrestBuilder.add(:ELDEGOSS, "0.9x damage taken, grants Pixilate.")
            .damage_taken_mod { next 0.9 }
            .ability_provider { next :PIXILATE }
            .cairo(1, 4000)

CrestBuilder.add(:CRAMORANT, "Start off in Gorging form.")
            .battle_stat_mods do |pkmn, _|
...
CrestBuilder.add(:MORPEKO, "Start off Hangry, replaces Hunger Switch with Galvanize.")
...
CrestBuilder.add(:FALINKS, "Bug resists and STAB; grants Lancer.")
