...
UniLib.category("Noel") {
  ...
  TrainerModifier.add(:NOEL, "Noel", 0)
                 ...
                 .set_pkmn(3, :LOPUNNY, 58, :LIMBER, item: :LOPUNNITE, moves: [:FAKEOUT, :RETURN, :POWERUPPUNCH, :QUICKATTACK], nature: :JOLLY, ev: ATKSPE, happiness: 255)
...
UniLib.category("Radomus") {
  ...
  TrainerModifier.add(:RADOMUS, "Radomus", 0)
                 ...
                 .set_pkmn(2, :GALLADE, 63, :JUSTIFIED, item: :GALLADITE, moves: [:STRENGTH, :CLOSECOMBAT, :KNOCKOFF, :SHADOWSNEAK], iv: 31, gender: "M", nature: :JOLLY, ev: ATKSPE, name: "Gallade")
                 ...
                 .set_pkmn(5, :GARDEVOIR, 63, :QUEENLYMAJESTY, item: :CHOICESCARF, moves: [:PSYCHIC, :DAZZLINGGLEAM, :MOONBLAST, :SHADOWBALL], iv: 31, gender: "F", nature: :TIMID, ev: [104, 0, 0, 152, 0, 252], name: "Gossip Gardevoir")
...
UniLib.category("Terra") {
  ...
  TrainerModifier.add(:TERRA, "T3RR4", 1)
                 ...
                 .set_pkmn(1, :DONPHAN, 1, [:STURDY, :MAGICGUARD], item: :SHELLBELL, moves: [:ICESHARD, :ENDEAVOR, nil, nil], happiness: 0, name: "JESUS", unilib_flags: { radiant: true })
