RemiX.gym(0) {
  ...
  TrainerModifier.add(:Doxy, "Hera", 0)
                 .set_pkmn(0, :IGGLYBUFF, 13, :CUTECHARM)
                 .set_pkmn(1, :DUCKLETT, 8, :KEENEYE)

  TrainerModifier.add(:Casanova, "Andy", 0)
                 .set_pkmn(0, :PURRLOIN, 15, :LIMBER, moves: [:SCRATCH, :SCRATCH, :SCRATCH, :GROWL])
  ...
  TrainerModifier.add(:Casanova, "Saad", 0)
                 .set_pkmn(0, :SIMISAGE, 10, :GLUTTONY, item: SIMISAGE_CREST, moves: [:TRIATTACK, :SEEDBOMB, :NASTYPLOT])

  TrainerModifier.add(:Casanova, "Andy", 0)
                 .set_pkmn(0, :PURRLOIN, 18, :LIMBER)

  TrainerModifier.add(:SEACREST, "Seacrest", 0)
                 .set_pkmn(0, :BUTTERFREE, 14, :COMPOUNDEYES)
                 .set_pkmn(1, :BEAUTIFLY, 14, :GALEFORCE)
                 .set_pkmn(2, :BEEDRILL, 14, :SERENEGRACE, item: :CATALYZER)

  TrainerModifier.add(:Doxy, "Marigold", 0)
                 .set_pkmn(0, :PIKIPEK, 12, :KEENEYE)
                 .set_pkmn(1, :BOUNSWEET, 14, :LEAFGUARD, moves: [:SPLASH, :PLAYNICE, :RAPIDSPIN, :RAPIDSPIN])

  TrainerModifier.add(:COOLTRAINER_Male, "Seth", 0)
                 .set_pkmn(0, :WIMPOD, 15, :WIMPOUT)
                 .set_pkmn(1, :QWILFISH, 16, :INTIMIDATE)

  TrainerModifier.add(:Punk, "Macy", 0)
                 .set_pkmn(0, :LOPUNNY, 20, :KLUTZ, item: :ASSAULTVEST, moves: [:SWITCHEROO, :QUICKATTACK, :KNOCKOFF])

  TrainerModifier.add(:StreetRat, "Bob", 0)
                 .set_pkmn(0, :GLAMEOW, 15, :LIMBER, moves: [:FAKEOUT, :SCRATCH, nil, nil])
                 .set_pkmn(1, :SKIPLOOM, 15, :AERILATE, moves: [:DOUBLEEDGE, :SYNTHESIS])
