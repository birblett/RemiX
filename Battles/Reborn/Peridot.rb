RemiX.gym(0) {
  ...
  TrainerModifier.add(:YOUNGSTER, "Sid", 0)
                 ...
                 .set_pkmn(1, :PIKACHU, 14, :ADAPTABILITY)

  TrainerModifier.add(:StreetRat, "Murphy", 0)
                 .set_pkmn(0, :LEDYBA, 14, :SWARM)
                 .set_pkmn(1, :RATTATA, 15, :STRONGJAW, form: 1)

  TrainerModifier.add(:YOUNGSTER, "Tony", 0)
                 .set_pkmn(0, :KRICKETUNE, 15, :TECHNICIAN, moves: [:FURYCUTTER, nil, nil, nil])
                 .set_pkmn(1, :EKANS, 16, :INTIMIDATE)
  ...
  TrainerModifier.add(:Doxy, "Shawna", 0)
                 .set_pkmn(0, :ODDISH, 14, :ADAPTABILITY)
                 .set_pkmn(1, :ODDISH, 14, :TERAVOLT)
                 .set_pkmn(2, :ODDISH, 14, :DOOMSEER)

  TrainerModifier.add(:YOUNGSTER, "Jackie", 0)
                 .set_pkmn(0, :ZIGZAGOON, 14, :GLUTTONY, item: :ORANBERRY, moves: [:BELLYDRUM, :EXTREMESPEED, :BITE, nil])
                 .set_pkmn(1, :BIBAREL, 16, :SIMPLE, moves: [:SWORDSDANCE, :QUICKATTACK, :AQUAJET, nil])
  ...
  TrainerModifier.add(:Punk, "Trill", 0)
                 ...
                 .set_pkmn(2, :ARIADOS, 18, :SWARM, moves: [:STICKYWEB, :XSCISSOR, :GUNKSHOT, :SHADOWSNEAK])

  TrainerModifier.add(:StreetRat, "Arnie", 0)
                 .set_pkmn(0, :FLETCHLING, 18, :GALEWINGS)

  TrainerModifier.add(:FISHERMAN, "Milhouse", 0)
                 .set_pkmn(0, :CLAUNCHER, 18, :MEGALAUNCHER)

  TrainerModifier.add(:COOLTRAINER_Male, "Roger", 0)
                 .set_pkmn(0, :SANDSHREW, 14, :ADAPTABILITY)
                 .set_pkmn(1, :DIGLETT, 15, :ARENATRAP)

  TrainerModifier.add(:StreetRat, "Reginald", 0)
                 .set_pkmn(0, :SCATTERBUG, 5, :SHIELDDUST)
                 .set_pkmn(1, :NIDORINO, 19, :HUSTLE)

  TrainerModifier.add(:StreetRat, "Erick", 0)
                 .set_pkmn(0, :KAKUNA, 12, :SHIELDDUST)
                 .set_pkmn(1, :PINECO, 16, :STURDY, ev: HPATK, nature: :BRAVE, moves: [:PROTECT, :EXPLOSION])

  TrainerModifier.add(:StreetRat, "Charlie", 0)
                 .set_pkmn(0, :SALANDIT, 15, :CORROSION)
                 .set_pkmn(1, :KECLEON, 15, :PROTEAN)
