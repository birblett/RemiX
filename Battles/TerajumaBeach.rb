AltBalance.chapter(5) {
  ...
  TrainerModifier.add(:POKEMONRANGER_M1, "Sam", 0)
                 ...
                 .set_pkmn(2, :CLAWITZER, 42, :MEGALAUNCHER, item: :CLAWITZERCREST, moves: [:WATERPULSE, :TERRAINPULSE, :DARKPULSE, :AURASPHERE], ev: SPASPE, nature: :TIMID)
...
AltBalance.chapter(8) {
  ...
  TrainerModifier.add(:TEAMAA_M, "Sigyrd", 0)
                 .set_pkmn(0, :RAMPARDOS, 60, :SHEERFORCE, item: :RAMPCREST, moves: [:HEADSMASH, :FIREPUNCH, :ICEPUNCH, :IRONHEAD], ev: ATKSPE, nature: :ADAMANT)
                 .set_pkmn(1, :BASTIODON, 60, :STURDY, item: :BASTCREST, moves: [:ROCKSLIDE, :METALBURST, :PROTECT, :TOXIC], ev: HPDEF, nature: :RELAXED)
  ...
  TrainerModifier.add(:TEAMAA_M, "Jalen", 0)
                 ...
                 .set_pkmn(4, :PROBOPASS, 60, :MAGNETPULL, item: :PROBOCREST, moves: [:POWERGEM, :FLASHCANNON, :THUNDERBOLT, :BODYPRESS], ev: HPSPA, nature: :MODEST)
