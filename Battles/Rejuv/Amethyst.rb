AltBalance.chapter(2) {
  ...
  TrainerModifier.add(:LADY, "Era", 0)
                 ...
                 .set_pkmn(3, :MIGHTYENA, 25, :MOXIE, item: :MIGHTYENACREST, moves: [:CRUNCH, :ICEFANG, :THUNDERFANG, :FIREFANG], nature: :ADAMANT)
...
AltBalance.chapter(6) {
  ...
  TrainerModifier.add(:LEADER_KETA2, "Keta", 0)
                 ...
                 .set_pkmn(3, :KROOKODILE, 46, :MOXIE, item: :KROOKODILECREST, moves: [:CRUNCH, :EARTHQUAKE, :FIREFANG, :FIREFANG], ev: ATKSPE)
                 .set_pkmn(4, :LAPRAS, 46, :WATERABSORB, item: :LAPRASCREST, moves: [:SURF, :PSYCHIC, :FREEZEDRY, :ANCIENTPOWER], nature: :MODEST, ev: HPSPA)
...
AltBalance.chapter(7) {
  ...
  TrainerModifier.add(:SUPERSTAR, "Nancy", 0)
                 ...
                 .set_pkmn(5, :MILOTIC, 53, :MARVELSCALE, item: :MILOTICCREST, moves: [:COIL, :FACADE, :POISONJAB, :DRAGONTAIL], ev: HPSPD, nature: :CAREFUL, form: 1)
