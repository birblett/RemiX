RemiX.chapter(6) {
  ...
  TrainerModifier.add(:DIABOLICALGENIUS, "Mr. Hynde", 0)
                 .set_pkmn(0, :MORPEKO, 45, :HUNGERSWITCH, item: MORPEKO_CREST, moves: [:FAKEOUT, :AURAWHEEL, :SEEDBOMB, :RETURN], nature: :JOLLY, ev: ATKSPE)
                 .set_pkmn(1, :CLAWITZER, 45, :MEGALAUNCHER, item: CLAWITZER_CREST, moves: [:WATERPULSE, :TERRAINPULSE, :DARKPULSE, :DRAGONPULSE], nature: :MODEST, ev: HPSPA, form: 0)
